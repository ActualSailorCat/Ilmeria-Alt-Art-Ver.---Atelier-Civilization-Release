...
VALUES	('SAILOR_ILMERIA_ALT_Civics',			'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Civics'),
		('SAILOR_ILMERIA_ALT_Techs',			'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Technologies'),
		('SAILOR_ILMERIA_ALT_Buildings',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Buildings'),
		('SAILOR_ILMERIA_ALT_Districts',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Districts'),
		('SAILOR_ILMERIA_ALT_Improvements',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Improvements'),
		('SAILOR_ILMERIA_ALT_PseudoYields',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'PseudoYields'),
		('SAILOR_ILMERIA_ALT_Yields',			'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Yields'),
		('SAILOR_ILMERIA_ALT_Units',			'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Units'),
		('SAILOR_ILMERIA_ALT_Settle',			'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Settle'),
		('SAILOR_ILMERIA_ALT_Alliances',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Alliances'),
		('SAILOR_ILMERIA_ALT_Diploaction',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'DiplomaticActions'),
		('SAILOR_ILMERIA_ALT_Discussions',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Discussions'),
		('SAILOR_ILMERIA_ALT_Resolutions',		'TRAIT_AGENDA_SAILOR_ILMERIA_ALT',		'Resolutions');
...
-- YIELDS
		...
		('SAILOR_ILMERIA_ALT_Yields',			1,			'YIELD_PRODUCTION',					0),	
-- PSEUDOYIELDS
		('SAILOR_ILMERIA_ALT_PseudoYields',		1,			'PSEUDOYIELD_GPP_SCIENTIST',		50),
		('SAILOR_ILMERIA_ALT_PseudoYields',		1,			'PSEUDOYIELD_GPP_ENGINEER',			50),
...
-- BUILDINGS & DISTRICTS			
		...
		('SAILOR_ILMERIA_ALT_Districts',		1,			'DISTRICT_INDUSTRIAL_ZONE',			50),	
-- IMPROVEMENTS
...
-- CIVICS & TECHS
		...
		('SAILOR_ILMERIA_ALT_Techs',			1,			'TECH_WRITING',						25), 
		('SAILOR_ILMERIA_ALT_Techs',			1,			'TECH_APPRENTICESHIP',				25), 
		('SAILOR_ILMERIA_ALT_Techs',			1,			'TECH_MATHEMATICS',					0),
		('SAILOR_ILMERIA_ALT_Techs',			1,			'TECH_EDUCATION',					25),
